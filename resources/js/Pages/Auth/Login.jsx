...
export default function LoginPage() {
    ...
    return (
        <div className="mx-auto max-w-screen min-h-screen bg-black text-white md:px-10 px-3">
            ...
            {/* Background Image - Menggunakan positioning yang benar */}
                    ...
                    <div>
                        ...
                        <form className="w-full" onSubmit={submit}>
                            ...
                            <div className="flex flex-col gap-4 mt-8">
                                ...
                                <Link
                                    href={route("register")}
                                    className="rounded-2xl border border-gray-600 hover:bg-gray-800 transition-colors py-3 text-center block"
                                >
                                    Create New Account
                                </Link>
                            </div>
