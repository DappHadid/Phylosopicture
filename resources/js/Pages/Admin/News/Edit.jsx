...
export default function Edit({ auth, news }) {
    const { data, setData, post, processing, errors } = useForm({
        _method: "PUT", // Method override untuk update
        title: news.title || "",
        description: news.description || "",
        category: news.category || "latest",
        date: news.date ? news.date.substring(0, 10) : "", // Format YYYY-MM-DD
        link: news.link || "",
        image: null, // Di-handle terpisah
    });
    ...
    const submit = (e) => {
        e.preventDefault();
        // Inertia akan otomatis mengirim sebagai multipart/form-data jika ada file
        post(route("admin.news.update", news.news_id));
    };
    ...
    return (
        <AdminLayout header="Edit News">
            <Head title={`Admin - Edit ${news.title}`} />
            <div className="max-w-5xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div>
                        ...
                        <div className="mt-6">
                            <label className={labelClassName}>New Image</label>
                            <input
                                type="file"
                                accept="image/*"
